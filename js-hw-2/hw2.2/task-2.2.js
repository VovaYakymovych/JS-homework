// я написав всі програми в одному файлі для зручності,
// щоб запустити потрібно розкоментувати одну з них


// ======================================task-6=============================================


// let x = +prompt('Введіть число для task-6');
// if (x===0){
//   console.log('Вірно')
// }
// else{
...
// let time = +prompt('Введіть число від 0 до 59 для task-7')
//
// if (time >= 0 && time <= 14){
...
// let day =+prompt('Введіть число від 0 до 31 для task-9')
//
// if (day >= 1 && day <= 10){
...
// let day = prompt('Введіть день тижня для task-9')
//
// let schedule = {
